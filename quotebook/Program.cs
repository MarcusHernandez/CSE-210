...
_board.AddQuote(
    new Quote(
        ...
        new Source(
            ...
            "https://www.chruchofjesuschrist.org/study/new-era/2012/03/how-to-dare-great-things?lang=eng"
        )
 
    )
);
_board.AddQuote(new Quote("Alma","If ye have faith ye hope for things which are not seen, which are ture.",new Source("Alma 32:21")));
